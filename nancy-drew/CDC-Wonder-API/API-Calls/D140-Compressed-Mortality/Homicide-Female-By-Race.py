"""
Retrieves female homicides by race report from the CDC Wonder API D140 database (Compressed Mortality, 1999-2016 Report).
...
# Response body file
fileExt = '.xml'
fileName = endpoint.replace('/', '') + '-Homicide-Female-by-Race' + fileExt

# Sends query parameters to the API and saves the response
with open(fileName, 'w') as file:
    with open('../../Query-Parameters/Homicide-Female-by-Race-xml_string.txt', 'r') as parameters:
